...
pub const SPV_REFLECT_MAX_ARRAY_DIMS: ::std::os::raw::c_uint = 32;
pub const SPV_REFLECT_MAX_DESCRIPTOR_SETS: ::std::os::raw::c_uint = 64;
...
#[doc = "@brief Information about an OpType* instruction"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = "@brief The OpVariable that is either an Input or Output to the module"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
